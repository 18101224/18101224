...
<html>
    ...
    <body>
        ...
        <div>
        사용한 라이브러리로는 numpy, matplotlib, pandas, scipy, statsmdoels 등이 있으며, 오픈소스 강의자료와 수업내용과 위 오픈소스들의 userguide의 함수조작법만 참고하였습니다. 
        </div>
        <h1>현재 확진자 추이</h1>
        <div>
        ...
        최소제곱법(Ordinary Least Squares)을 사용하여 회귀직선의 계수를 구하는 함수입니다. 여기서는 단순 '백신접종률'만을 변수로 취하여 넣어줬는데 그냥 평균 값을 구하는 정도로 의미있는 분석 결과를 내놓지 않았습니다. 
